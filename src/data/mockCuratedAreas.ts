...
export const SUDIRMAN_GRAVITY_CENTER = {
  ...
  latLng: [-6.215, 106.820] as [number, number],
...
export const initialCuratedAreas: CuratedArea[] = [
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'krl', label: 'Stasiun Jurang Mangu', distance: '600 m jalan kaki', interval: 'Setiap 8–10 menit' },
      { type: 'tol', label: 'Gerbang Tol Pondok Aren', distance: '1,8 km', interval: 'Akses JORR / Bandara' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 4,
    transitOptions: [
      { type: 'krl', label: 'Stasiun Cisauk (Intermoda)', distance: '850 m', interval: 'Setiap 10 menit' },
      { type: 'tol', label: 'Tol Serbaraja Pintu 2', distance: '2,5 km', interval: 'Koneksi Tol Jakarta-Serpong' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'tol', label: 'Gerbang Tol Sawangan 4 (Desari)', distance: '1,5 km', interval: 'Akses TB Simatupang' },
      { type: 'krl', label: 'Stasiun Citayam / Depok', distance: '5,8 km', interval: 'Feeder angkot / ojol' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'krl', label: 'Stasiun Pondok Cina', distance: '700 m', interval: 'Setiap 5–7 menit' },
      { type: 'tol', label: 'Gerbang Tol Margonda (Cijago)', distance: '1,2 km', interval: 'Koneksi Jagorawi & JORR 2' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'tol', label: 'Gerbang Tol Pamulang', distance: '1,1 km', interval: 'Tol Serpong-Cinere' },
      { type: 'mrt', label: 'Feeder TransJakarta MRT Lebak Bulus', distance: '6,5 km', interval: 'Setiap 15 menit' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'lrt', label: 'Stasiun LRT Harjamukti', distance: '1,8 km', interval: 'Setiap 6–10 menit' },
      { type: 'tol', label: 'Gerbang Tol Cibubur (Jagorawi)', distance: '2,2 km', interval: 'Tol Dalam Kota' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 3,
    transitOptions: [
      { type: 'krl', label: 'Stasiun Kranji & Bekasi', distance: '1,2 km', interval: 'Setiap 5 menit' },
      { type: 'tol', label: 'Tol Becakayu / Jakarta-Cikampek', distance: '1,5 km', interval: 'Akses Cawang' },
    ],
    essentialFacilities: {
  ...
  },
  {
    ...
    checkpointsCount: 4,
    transitOptions: [
      { type: 'krl', label: 'Stasiun Cikarang', distance: '2,5 km', interval: 'Setiap 15 menit' },
      { type: 'tol', label: 'Gerbang Tol Cikarang Barat (MBZ)', distance: '3,0 km', interval: 'Tol Layang Jakarta' },
    ],
    essentialFacilities: {
