...
const CATEGORIES: FacilityCategory[] = [
  ...
  },
  {
    ...
    icon: <PendidikanIcon />,
    items: [{ name: "SDN Grand Galaxy", distance: "1.62 km" }],
  },
  {
    key: "belanja",
        ...
        >
          ...
          <div className="flex flex-col items-start min-w-0 flex-1">
            ...
            <div className="flex items-center gap-1 mt-0.5 text-xs flex-wrap min-w-0">
              <Badge
                variant={cat.proximityVariant}
                size="sm"
                className="whitespace-nowrap text-[10px] sm:text-xs py-0 px-1.5 font-bold shrink-0"
              >
                {cat.proximityLabel}
              </Badge>
              <span className="text-slate-400 font-medium text-xs whitespace-nowrap">
                · terdekat{" "}
                <strong className="tabular-nums font-semibold text-slate-600 whitespace-nowrap">
                  {cat.nearestKm}
                </strong>
              </span>
            </div>
