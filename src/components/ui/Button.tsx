...
export default function Button({
  ...
  const variantStyles: Record<ButtonVariant, string> = {
    primary: 'bg-[#0F2B38] text-white border border-[#0F2B38] hover:bg-[#163b4d]',
    ...
    upgrade: 'bg-[#00E676] text-[#062B23] border border-transparent hover:opacity-90 active:scale-95 shadow-2xs font-bold rounded-full',
  }
