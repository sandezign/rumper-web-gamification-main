      ...
      <div className="relative flex-1 min-w-0">
        ...
        {canScrollRight && (
          <button
            ...
            style={{ background: 'linear-gradient(to right, transparent, #F4F7F8 60%)', border: 'none' }}
          ...
          {ALL_TABS.map((tab) => {
            ...
            if (isLocked) {
              return (
                <button
                  ...
                  style={{ border: '1px dashed #B9C8D2', backgroundColor: '#F8FAFC', color: '#475569' }}
                >
            ...
            if (isActive) {
              return (
                <button
                  ...
                  style={{ backgroundColor: '#0F2B38', color: '#FFFFFF', border: '1.5px solid #0F2B38' }}
                >
                  {tab}
                </button>
              )
            ...
            return (
              <button
                ...
                style={{ backgroundColor: 'transparent', border: '1px solid #C1CCD6', color: '#3d4f5b' }}
              >
                {tab}
              </button>
            )
