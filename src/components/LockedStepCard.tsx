    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-3">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
          <rect x="2" y="5.5" width="8" height="5.5" rx="1" stroke="#94A3B8" strokeWidth="1.2" />
          <path d="M4 5.5V4a2 2 0 0 1 4 0v1.5" stroke="#94A3B8" strokeWidth="1.2" strokeLinecap="round" />
        </svg>
        <span className="text-xs font-medium" style={{ color: '#94A3B8' }}>Terbuka setelah upgrade</span>
      </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          ...
          style={{ border: '1px solid #c1ccd6', color: '#7c8c9a', backgroundColor: 'transparent' }}
          onClick={(e) => { e.stopPropagation(); onUpgrade() }}
        >
          Lihat di peta
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            <path d="M3.5 8.5l5-5M7 3.5h2v2" stroke="#7c8c9a" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </div>
    </div>
